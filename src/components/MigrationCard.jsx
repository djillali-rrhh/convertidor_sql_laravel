...
export default function MigrationCard({
  ...
  return (
    <div className="bg-slate-950/80 rounded-xl p-4 border border-slate-700/50 hover:border-blue-700/50 transition-all group">
      ...
      <pre className={`text-yellow-300 text-xs overflow-x-auto whitespace-pre-wrap ${expandedId === migration.id ? '' : 'max-h-32 overflow-hidden'}`}>
